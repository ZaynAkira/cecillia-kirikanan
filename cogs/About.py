...
class About(commands.Cog):
    ...
    async def about(self, ctx:Context):
        embed = discord.Embed(
            title = "= Cecillia's Current Information =",
        ...
        embed.add_field(
            name="⠀",
            value="[Invite Cecillia!](https://discord.com/api/oauth2/authorize?client_id=864043720297938946&permissions=8&scope=bot) | [Join Chrono Curses!](https://discord.gg/VhKVdmNsGq) | [Check out my GitHub!](https://github.com/ZaynAkira/cecillia-kirikanan)",
            inline=False
        )
