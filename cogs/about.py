...
class About(commands.Cog):
    ...
    async def about(self, ctx:Context):
        ...
        embed.add_field(
            name="⠀",
            value="[Invite Cecillia!](https://discord.com/api/oauth2/authorize?client_id=616304535870242838&permissions=2145254646&scope=bot) | [Check out our GitHub](https://github.com/ZaynAkira/cecillia-kirikanan) | [Join Chrono Curses!](https://discord.gg/VhKVdmNsGq)",
            inline=False
        )
